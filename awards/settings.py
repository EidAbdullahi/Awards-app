...
SECRET_KEY = '^kjw=fjuul40i668m+sepn&f^13xsp1!*ola&%0%ak82j1g_n5'
...
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/1.11/howto/static-files/abdiiilesStorage'
